...
- **`references/AGENT_SKILL.template.md`** - Skill YAML frontmatter and body structure template
- **`references/SUBAGENT.template.md`** - Subagent configuration template with frontmatter fields and instructions
